...
contract NudgePointsCampaignsTest is Test {
  ...
  function test_CreatePointsCampaign_StoresCampaign() public {
    ...
    (uint32 holdingPeriodInSeconds_, address targetToken_, uint256 pID_, uint256 totalReallocatedAmount_) = campaigns
  ...
  function test_CreateBatchCampaigns() public {
    ...
    (uint32 holdingPeriodInSeconds2, address targetToken2, uint256 pID2, uint256 totalReallocatedAmount2) = campaigns
      .campaigns(campaignIds[1]);
